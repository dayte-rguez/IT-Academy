...
namespace Fase2
{
    class Program
    {
        ...
        static Dictionary<string, string> AddStudentsMenuOptions = new Dictionary<string, string>()
        {
            {EndKeyword, "Exit this Menu"},
        };
        ...
        static void ShowAddStudentsMenu()
        {
            Console.WriteLine("\n-- Add Student Menu Options --");
            ShowMenuOptions(AddStudentsMenuOptions);
        }
        static string GetMenuOption(Dictionary<string, string> aMenu, out bool isValid)
        {
            var selectedMenuOption = GetMenuOption();
